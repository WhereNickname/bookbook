...
const ORIGINAL_BOOKS: FeedBook[] = [
  { title: '데미안', author: '헤르만 헤세', category: '성장 소설', genres: ['고전문학', '해외'], coverStyle: 'demian', coverMark: '½', coverData: 'LIGHT / SHADOW', quote: '내 안에는 두 개의 세계가 있었다.\n하나는 부모님의 집처럼 밝고 안전했고, 다른 하나는 이상하리만큼 두려우면서도 나를 끌어당겼다.', color: '#ff5b35', foreground: '#20130e', description: '선과 악의 경계를 넘어 자기 자신에게 도달하려는 한 소년의 내면을 따라가는 성장 소설.' },
  ...
  { title: '싯다르타', author: '헤르만 헤세', category: '고전 소설', genres: ['고전문학', '해외'], coverStyle: 'siddhartha', coverMark: '≈', coverData: 'RIVER / SELF', quote: '싯다르타는 누구보다 많은 것을 배웠다.\n하지만 이상하게도, 배울수록 자신이 아직 아무것도 모른다는 생각이 커졌다.', color: '#39b8a6', foreground: '#102f2d', description: '배움과 방황을 지나 흐르는 강 앞에서 삶과 자아의 의미를 발견하는 구도의 이야기.' },
  { title: '채식주의자', author: '한강', category: '한국 소설', genres: ['한국'], coverStyle: 'vegetarian', coverMark: 'Y', coverData: 'ROOT / BODY', quote: '영혜는 어느 날 갑자기 고기를 먹지 않겠다고 말했다.\n이유를 묻자, 그녀는 단지 꿈을 꾸었다고 했다.', color: '#d2e8c5', foreground: '#31542f', description: '한 사람의 조용한 거부가 평범했던 일상을 흔들며 만들어내는 낯설고 강렬한 균열.' },
  { title: '코스모스', author: '칼 세이건', category: '과학 교양', genres: ['해외', '영어원문'], coverStyle: 'cosmos', coverMark: '∞', coverData: '13.8 BY / 10²⁴', quote: '우리는 우주를 바라본다.\n하지만 사실 우리가 보고 있는 것은, 거의 전부 과거다.', color: '#17152d', foreground: '#eee9ff', description: '우주의 탄생에서 인간의 질문까지, 광대한 시공간 속 우리의 위치를 아름답게 설명한다.' },
  { title: '인간실격', author: '다자이 오사무', category: '고전 소설', genres: ['고전문학', '해외'], coverStyle: 'disqualified', coverMark: '失格', coverData: 'HUMAN / NULL', quote: '나는 인간의 삶이라는 것을 도무지 이해할 수 없었다.\n그래서 사람들에게 들키지 않기 위해, 웃기는 사람이 되었다.', color: '#d8d5ce', foreground: '#1a1918', description: '타인의 세계에 섞이지 못한 한 인간의 고백을 통해 불안과 소외의 가장 깊은 곳을 바라본다.' },
...
const ADDED_BOOKS: FeedBook[] = [
  ...
  {"title":"변신","author":"프란츠 카프카","category":"고전 소설","genres":["문학","고전문학","해외"],"coverStyle":"metamorphosis","coverMark":"Ж","coverData":"ROOM / APPLE","color":"#733b29","foreground":"#f3ddbb","description":"아침에 달라진 몸과 방문 밖에서 기다리는 가족.","coverPattern":"split","quote":"눈을 떴을 때, 그레고르는 자신이 더 이상 인간의 몸을 하고 있지 않다는 것을 알았다.\n그러나 이상하게도 그가 가장 먼저 걱정한 것은 자신의 몸이 아니라 출근 시간이었다."},
